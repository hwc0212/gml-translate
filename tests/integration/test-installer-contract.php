...
gml_test_assert( GML_Installer::DB_VERSION === '3.6.0', 'pins the additive item-resolution database version' );
gml_test_assert( strpos($source,'gml_item_resolutions') !== false && strpos($source,'UNIQUE KEY active_slot') !== false, 'page decisions are separate, uniquely scoped assets' );
